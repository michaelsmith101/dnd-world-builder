...
RSpec.describe SessionsController, type: :controller do
    let(:my_user) {User.create!(name: "Test User", email: "test@email.com", password: "password")}
    ...
    describe "POST sessions" do
        ...
        it "does not add a user id to a session due to a missing password" do
           post :create, session: {email: my_user.email}
